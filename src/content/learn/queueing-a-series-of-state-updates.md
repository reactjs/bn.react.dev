...
আপনি হয়তো অনুমান করতে পারেন যে, "+3" বাটনে ক্লিক করার পর, বাটনটি কাউন্টার কে তিন বার বৃদ্ধি করবে কারণ এটা এই `setNumber(number + 1)` ফাংশনকে ৩ বার কল করেঃ
...
পরবর্তী রেন্ডারের সময়, React state এর সারির মধ্য দিয়ে যায়ঃ
...
`HandleClick` ইভেন্ট হ্যান্ডলারের ভিতরে, `Pending` এবং `Completed` এর মানগুলি ক্লিক ইভেন্টের সময় যা ছিল তার সাথে মিলে যায়। প্রথম রেন্ডারের জন্য, `Pending` ছিল `0`, তাই `setPending(pending - 1)` হয়ে `setPending(-1)`, যা ভুল। যেহেতু আপনি কাউন্টারগুলিকে *বৃদ্ধি* বা *হ্রাস* করতে চান, ক্লিক করার সময় নির্ধারিত একটি কংক্রিট মান সেট করার পরিবর্তে, আপডেটার ফাংশনগুলি পাস করতে পারেনঃ
...
আপনি দুটি আর্গুমেন্ট পাবেনঃ `Base state` হল প্রারম্ভিক অবস্থা (যেমন `0`), এবং `Queue` হল একটি অ্যারে যাতে সংখ্যার মিশ্রণ থাকে (যেমন `5`) এবং আপডেটার ফাংশন (যেমন `n => n + 1`) ক্রমানুসারে তাদের যোগ করা হয়েছে।
...
এটি এই পৃষ্ঠায় বর্ণিত সঠিক অ্যালগরিদম যা react চূড়ান্ত state গণনা করতে ব্যবহার করেঃ
...
এখন আপনি জানেন কিভাবে react এই অংশে কাজ করে!
