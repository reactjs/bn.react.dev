...
React এর কম্পোনেন্টগুলো একে অপরের সাথে যোগাযোগ করতে *props (প্রপ্‌স)* ব্যবহার করে। প্রতিটি প্যারেন্ট কম্পোনেন্ট তার চাইল্ড কম্পোনেন্টদের props প্রদান করার মাধ্যমে কিছু তথ্য পাঠাতে পারে। Props হয়তো আপনাকে HTML Attributes এর মতো মনে হতে পারে, কিন্তু এগুলোর মাধ্যমে আপনি অবজেক্ট, অ্যারে এবং ফাংশন এর পাশাপাশি যে কোন JavaScript ভ্যালু পাঠাতে পারেন।
...
Props হল সেই তথ্য যেটি আপনি একটি JSX ট্যাগ-এ পাঠান। উদাহরণ হিসেবে, `className`, `src`, `alt`, `width`, এবং `height` হল কিছু props যেগুলো আপনি  একটি `<img>` ট্যাগ-এ পাঠাতে পারেন:
...
একটি `<img>` ট্যাগ-এ আপনি যেসব props পাঠাতে পারবেন সেটি পূর্বনির্ধারিত ([HTML standard](https://www.w3.org/TR/html52/semantics-embedded-content.html#the-img-element)-কে ReactDOM মেনে চলে)। কিন্তু আপনি `<Avatar>` এর মতো *আপনার নিজস্ব*  কম্পোনেন্টগুলোকে কাস্টমাইজ করতে চাইলে যেকোন props পাঠাতে পারেন। কীভাবে করবেন দেখুন! 
...
আপনি দুই ধাপে `Avatar`-এ কিছু props দিতে পারেন।
