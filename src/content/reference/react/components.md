...
* [`<Activity>`](/reference/react/Activity) এটি আপনাকে এর চাইল্ড এলিমেন্টগুলোর (children) ইউজার ইন্টারফেস (UI) এবং ইন্টারনাল স্টেট (internal state) লুকিয়ে রাখা এবং পুনরায় ফিরিয়ে আনার সুবিধা দেয়।.
