...
[context](/learn/passing-data-deeply-with-context) পড়া এবং সেখানে সাবস্ক্রাইব করার জন্য `useContext` কে আপনার কম্পোনেন্ট এর একেবারে উপরের স্তরে কল করতে হবে।
...
* `SomeContext`: এটি হচ্ছে সেই context যেটি আপনি পূর্বে [`createContext`](/reference/react/createContext) দ্বারা তৈরি করেছিলেন। context নিজে থেকে তথ্য ধারণ করে না, এটি শুধুমাত্র সেই তথ্যগুলিকেই উপস্থাপন করে যা আপনি প্রদান করতে অথবা কম্পোনেন্ট থেকে পড়তে পারেন।

#### রিটার্নস {/*returns*/}

`useContext` যে কম্পোনেন্টে কল করা হয় তার জন্য context এর ভ্যালু রিটার্ন করে। যে কম্পোনেন্ট কল করা হয়েছে তার উপরে কম্পোনেন্ট ট্রির সব থেকে কাছের `SomeContext.Provider` দ্বারা এটি নির্ধারিত হয় যা `value` হিসাবে পাঠানো হয়। যদি এমন কোন প্রদানকারী না থাকে, তাহলে রিটার্নকৃত মান হবে `defaultValue`  যা আপনি context এর জন্য [`createContext`](/reference/react/createContext) এ পাঠিয়েছিলেন। রিটার্নকৃত মান সবর্দা আপ টু ডেট হবে। যদি context এ কোন পরিবর্তন হয়, তাহলে তাহলে React স্বয়ংক্রিয়ভাবে সেই কম্পোনেন্টগুলোকে পুনরায় রেন্ডার করবে যারা context পড়েছিল।

#### সতর্কতা {/*caveats*/}

* একটি কম্পোনেন্টের ভিতর `useContext()` কল করা হলে সেই *একই* কম্পোনেন্ট থেকে রিটার্নকৃত প্রদানকারীদের দ্বারা এটি প্রভাবিত হবে না। যে কম্পোনেন্ট থেকে `useContext()` কল করা হয়েছে, সংশ্লিষ্ট `<Context.Provider>` কে সেই কম্পোনেন্টের ***উপরে* থাকতে হবে**
* প্রদানকারীর শুরু থেকে যেসব চিলড্রেন একটি নির্দিষ্ট context ব্যবহার করে সেটি যখন ভিন্ন `মান` গ্রহণ করে তখন React সেসব চিলড্রেনকে **স্বয়ংক্রিয়ভাবে পুনরায় রেন্ডার** করে। পূর্ববর্তী এবং পরবর্তী মান [`Object.is`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object/is) দ্বারা তুলনা করা হয়। পুনরায় রেন্ডার এড়িয়ে যেতে যেসব চিলড্রেনে [`memo`](/reference/react/memo) ব্যবহার করা হয়, সেখানে context এর নতুন মান পেতে বাধা দেওয়া হয় না।
* যদি আপনার বিল্ড সিস্টেম আউটপুটে ডুপ্লিকেট মডিউল উৎপাদন করে (যা symlinks দ্বারা তৈরি হয়), তাহলে সেটা আপনার context কে ভেঙে ফেলতে পারে। কোন কিছু যখন context এর মাধ্যমে পাঠানো হয়, সেটি শুধুমাত্র তখনই কাজ করবে যখন আপনার context প্রদান করার জন্য ব্যবহারকৃত `SomeContext` এবং পড়ার জন্য ব্যবহারকৃত `SomeContext` ***হুবহু* একই object** হবে, যা `===` তুলনা দ্বারা নির্ধারিত হয়।
